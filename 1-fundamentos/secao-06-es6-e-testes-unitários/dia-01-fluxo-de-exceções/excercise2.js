const clients = [
  ...
  const findPersonByName = (name) => {
    ...
    for (let index = 0; index < clients.length; index += 1){
        ...
        const address = `Endereço: ${person.address.street}, ${person.address.number}, ${person.address.neighborhood}, ${person.address.city} - ${person.address.state}. CEP: ${person.address.cep}`
